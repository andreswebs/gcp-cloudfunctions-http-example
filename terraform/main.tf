locals {
  function_object = "function-test-http.zip"
  function_name   = substr("function-test-http-${random_string.function_suffix.result}", 0, 63)
}
...
module "function_test" {
  ...
  schedule_name                 = "function-test-http"
  function_service_account_name = "function-test-http"
